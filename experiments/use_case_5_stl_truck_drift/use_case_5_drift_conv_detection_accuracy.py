...
def main():
    ...
    if args.save_results:
        ...
        output_filename = f"drift_detection_accuracy_model_{args.model_name}_conv_win_size_{args.window_size}_n_windows_{args.number_of_windows}_{timestamp}.json"
    ...
    print("Embedding shape:", E_train.shape)
